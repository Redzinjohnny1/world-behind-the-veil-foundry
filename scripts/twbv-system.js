...
function applyCustomItemDialogTheme(dialogWindow) {
  const apply = () => {
    ...
    const footer = root?.querySelector?.("footer.dialog-buttons, .window-content + footer, .dialog-buttons, footer");
    if (footer?.classList) footer.classList.add("twbv-vantagem-footer", "twbv-custom-item-footer");
