...
class TWBVArmorSheet extends ItemSheet { static get defaultOptions(){ return foundry.utils.mergeObject(super.defaultOptions,{classes:['twbv','sheet','item','armor-sheet'],width:680,height:680,submitOnChange:true,submitOnClose:true}); } get template(){ return `systems/${game.system.id}/templates/item/armor-sheet.hbs`; }}
